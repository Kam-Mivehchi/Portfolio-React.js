...
const Contact = (props) => {
    return (
        <div className='min-h-screen  flex flex-col items-center justify-center'>
            ...
            <form action="mailto:kammivehchi@gmail.com" method='POST' encType='multipart/form-data' name='EmailForm' className={`${props.sections} font-bold text-3xl max-w-full px-6`}>
                Name:<br></br>
